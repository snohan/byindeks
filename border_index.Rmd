...
pointindex_2020 <- get_published_pointindex(2952, 2020, 12)
...
## Per måned
Tabellen på neste side viser estimert samlet endring i trafikkmengde per måned i 2020, sammenlignet med samme måned i 2019. Usikkerheten i estimatet er synliggjort med et standardavvik.
...
index_2020_upper_lower %>%
  ...
  select(month_name, year, length_range, index_p, standard_deviation) %>%
  flextable() %>%
  ...
  align(i = 1, j = 4:5, align = "right", part = "header") %>% 
...
```{r lineplot, fig.width=6, fig.height=5, fig.cap="Estimert endring i trafikkmengde ved riksgrensen i 2020 sammenlignet med 2019."}
index_2020_upper_lower %>% 
  dplyr::filter(period == "month") %>% 
...
## Hittil i år
I tabellen nedenfor vises samlet endring i trafikkmengde i perioden fra januar til `r last_month_name` 2020, sammenlignet med samme periode i 2019. Usikkerheten i estimatet er synliggjort med et standardavvik.
