...
index_2021 <- get_published_index_for_months(2952, 2021, 1)

pointindex <- get_published_pointindex(2952, 2021, 1)
...
## Per måned
Tabellen på neste side viser estimert samlet endring i trafikkmengde per måned, sammenlignet med samme måned i fjor. Usikkerheten i estimatet er synliggjort med et standardavvik.
...
```{r lineplot_historic, fig.width=6, fig.height=8, fig.cap="Riksgrenseindeks foregående år.", cache=TRUE}
