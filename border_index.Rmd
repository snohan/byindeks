...
index_2020 <- get_published_index_for_months(2952, 2020, 11)

pointindex_2020 <- get_published_pointindex(2952, 2020, 11)
...
index_2020_upper_lower %>%
  ...
  set_header_labels(month_name = "Måned", year = "År", length_range = "Lengde- \n klasse",
...
index_2020_upper_lower %>%
  ...
  colformat_int(j = 2, big.mark = "") %>%
  colformat_double(j = 4:6, digits = 1) %>%
  set_header_labels(month_name = "Måned", year = "År", length_range = "Kjøretøy- \n klasse",
                    index_lower = "Endring i trafikkmengde (%)") %>%
  add_header_row(values = c("", "", "", "Nedre", "Estimat", "Øvre"), top = FALSE) %>% 
  merge_at(i = 1:2, j = 3, part = "header") %>% 
  merge_at(i = 1, j = 4:6, part = "header") %>% 
