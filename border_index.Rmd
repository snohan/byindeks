...
index_2021 <- get_published_index_for_months(2952, 2021, 8)

pointindex <- get_published_pointindex_for_months_paginated(2952, 2021, 8)
```
...
border_crossings_adt %>%
  ...
  set_header_labels(road_category_and_number = "Veg-nummer",
                    ...
                    aadt_long = "ÅDT \n tunge",
                    year = "År",
                    name = "Trafikk-registrerings-punkt") %>%
