...
index_2020 <- get_published_index_for_months(2952, 2020, 9)

pointindex_2020 <- get_published_pointindex(2952, 2020, 9)
...
Datagrunnlaget for beregningene hentes fra disse trafikkregistreringspunktene. Det vil gi et representativt utvalg for å kunne beregne trafikkutviklingen. Det gjøres en sammenligning av timetrafikken, dato mot dato i kalendermånedene.
...
Ved å slå sammen trafikkmengden i de ulike grenseovergangene, kan en samlet endring beregnes.
...
index_2020_upper_lower %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Estimert samlet endring i trafikkmengde ved riksgrensen, med nedre og øvre grense for et 95 % konfidensintervall. Trafikken er sammenlignet per måned med samme måned året før.")
```
...
index_2020_upper_lower %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Estimert samlet endring i trafikkmengde ved riksgrensen, med nedre og øvre grense for et 95 % konfidensintervall. Trafikken er sammenlignet for hittil i år med samme periode året før.")
```
...
```{r lineplot_historic, fig.height=8}
