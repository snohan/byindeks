...
# Bakgrunn
Dette notatet fokuserer på muligheten for å ta inn flere trafikkregistreringspunkt i byindeks for Nord-Jæren enn de 24 som ble tatt med fra referanseåret 2017. Etter at nye veger er åpnet, er det flere av de opprinnelige punktene som ikke er direkte sammenlignbare med referanseåret. Dermed blir byindeksen beregnet på et lite utvalg punkter som ikke er representative nok for trafikken i hele byområdet. Det er allerede etablert mange nye punkt i årene etter referanseår, og de fleste av disse er relevante å ta med i byindeksberegningen.


# Antall punkt
Antall punkt som er tilgjengelige og som utgjør et representativt utvalg varierer gjennom perioden. I @fig-n_trp vises antall punkt med gode data per år.

```{r}
#| label: fig-n_trp
#| fig-cap: "Antall punkt med gode data per år."
...
- Hvilke to år som sammenlignes (er det gode data og sammenlignbare data i begge år)
...
## Kart
I kartet nedenfor er trafikkregistreringspunkt merket med sirkel. Trafikklenken som et punkt ligger på er merket med linje, og denne viser hvilken del av vegnettet som punktet registrerer trafikken på.

```{r}
#| label: fig-map
#| fig-cap: "Opprinnelige og mulige punkt i 2023."
...
For å utnytte tilgjengelige trafikkregistreringspunkter best mulig, kan byindeksen beregnes periodevis. I det følgende er noen alternativer skissert.


## Om kjedet indeks
I flere av alternativene nevnt ovenfor er det foreslått å benytte kjedet indeks. En ulempe med kjeding er at usikkerheten akkumuleres for hvert ledd. Derfor er det ønskelig å holde antall ledd så lavt som mulig, samtidig som flest mulig punkt kan være med. Dette er den beste strategien for å kunne utnytte flest mulig punkt til en enhver tid.


## A1: Glidende indeks 2017-
Dette alternativet innebærer å beregne tre års glidende indeks direkte fra 2017. Det er dette som er den offisielle indeksen i skrivende stund. Det ble valgt ut 24 punkter i 2017.

Fordelen med dette alternativet er at det er relativt enkelt å beregne og forklare. Gjennomsnittlig trafikkmengde for de siste tre årene er direkte sammenlignet med trafikkmengden i referanseåret.

Ulempen er at over tid vil færre og færre punkt være direkte sammenlignbare med referanseåret. Dette er på grunn av strukturelle endringer i vegnettet.

Antall punkt som er med i indeksberegningen er vist i @fig-n_trp_a1.

```{r}
#| label: fig-n_trp_a1
#| fig-cap: "Antall punkt med i indeksberegning i alternativ 1."

  index_results |> 
    dplyr::filter(
      alternative == "A1",
      index_type == "36_months"
    ) |> 
    ggplot2::ggplot(aes(x = index_period, y = n_trp)) +
    ggplot2::geom_col(fill = "#ED9300") +
    theme_light() +
    theme(
...
## A2: Glidende indeks 2017-2019-
Dette alternativet innebærer å beregne tre års glidende indeks sammenlignet med 2019. Denne blir så kjedet sammen med en direkte indeks fra 2017 til 2019. Dette er metoden som er benyttet for Tromsø.

Fordelen er at flere punkter kan være med i perioden 2017-2019 enn en indeks som går direkte fra 2017 til 2023. Utvalget av punkt begrenses ikke til de 24 som opprinnelig ble valgt i 2017.
...
```{r}
#| label: fig-n_trp_a2
#| fig-cap: "Antall punkt med i indeksberegning i alternativ 2."
...
## A3: Glidende indeks 2017-2023-
Dette alternativet innebærer å beregne tre års glidende indeks sammenlignet med 2023. Denne blir så kjedet sammen med en direkte indeks fra 2017 til 2023.
...
Antall punkt som er med i indeksberegningen er vist i @fig-n_trp_a3.

```{r}
#| label: fig-n_trp_a3
#| fig-cap: "Antall punkt med i indeksberegning i alternativ 3."
...
## A4: Glidende indeks 2017-2019-2023-
...
```{r}
#| label: fig-n_trp_a4
#| fig-cap: "Antall punkt med i indeksberegning i alternativ 4."
...
```{r}
#| label: fig-n_trp_a5
#| fig-cap: "Antall punkt med i indeksberegning i alternativ 5."
...
Alternativ 2 og 4 har størst datagrunnlag, og er derfor de mest troverdige. Disse to indeksverdiene er også ganske like med 2,4 % og 2,8 %.

Ser vi på usikkerheten i form av bredden på konfidensintervallet, er alternativ 1 som peker seg negativt ut. Det forklares enkelt med at det er alternativet med færrest punkt. Men usikkerheten for de øvrige alternativene er nokså like, selv om antall punkt varierer en del. Dette skyldes at det er ganske stor forskjell i trafikkendring mellom punktene som inngår, og dette gir størst bidrag til usikkerheten.

Under alternativ 1 og 2 ser vi at usikkerheten for tre ås glidende snitt er noe lavere. Dette skyldes nok at det benyttes et gjennomsnitt av trafikken siste tre år. Dette jevner ut noen av variasjonene på det enkelte punkt.
