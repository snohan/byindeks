...
library(knitr)
library(flextable)
# AIzaSyCRq-TfJKi_l_9U7K1Xy5sFMjbR5A8V6LM
ggmap::register_google(key = "AIzaSyCRq-TfJKi_l_9U7K1Xy5sFMjbR5A8V6LM")
```
...
```{r map}
# ggmap - alt for dårlig oppløsning!!!
# trondheimskart <- 
#   get_map(location = c(10.4, 63.4), zoom = 12,
#           source = "google",
#           scale = 4,
#           maptype = "roadmap")
# ggmap(trondheimskart)
