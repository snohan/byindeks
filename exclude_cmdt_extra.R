...
exclusions_nj_okt18_sep19__2023 <-
  dplyr::bind_rows(
    table_exclusions(
      ...
      c("906727263", "906727262", "22231V320583", "906727257", "45342V320223", "50749V319525", "55507V319881", "71535V319524"), 
      61
    ),
    table_exclusions(
      "Åpning av Ryfylketunnelen", 
      c("12478V320582", "906727246", "40696V1727469", "41451V320581", "50741V1727509", "35382V1727514", "64040V320581", "66678V320582", "81631V1727485", "93189V320582")
    ),
    table_exclusions("Strandgata bygges om til bussvei", c("16074V319868", "906727238"), 100),
    table_exclusions("Ukjent", c("906727244", "71798V319583"), 94),
    table_exclusions("Ny arm mellom fv. og E39 ved Hove", c("906727237"), 40, 40),
...
exclusions_nj_2023__ <-
  dplyr::bind_rows(
    table_exclusions("Bussvegen?", c("12478V320582", "906727244")),
