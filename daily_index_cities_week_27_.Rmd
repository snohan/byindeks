...
week_2019_to <- "2019-07-29T00:00:00+02:00"

week_2020_from <- "2020-06-29T00:00:00+02:00"
week_2020_to <- "2020-07-27T00:00:00+02:00"
...
```
\
```{r plot_city_bergen, fig.width=8, fig.height=6}
...
```
\
```{r plot_city_nord_jaeren, fig.width=8, fig.height=6}
...
```
\
```{r plot_city_oslo_og_akershus, fig.width=8, fig.height=6}
...
```
\
```{r plot_city_tromsoe, fig.width=8, fig.height=6}
...
```
\
```{r plot_city_trondheim, fig.width=8, fig.height=6}
