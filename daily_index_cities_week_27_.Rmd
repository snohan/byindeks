...
week_2019_to <- "2019-07-22T00:00:00+02:00"

week_2020_from <- "2020-06-29T00:00:00+02:00"
week_2020_to <- "2020-07-20T00:00:00+02:00"
...
#Cities week by week
city_dt_2019_2020_weeks = bind_rows(city_dt_201927_202027,
...
```
\
```{r plot_city_bergen, fig.width=8, fig.height=3}
...
```
\
```{r plot_city_nord_jaeren, fig.width=8, fig.height=3}
...
```
\
```{r plot_city_oslo_og_akershus, fig.width=8, fig.height=3}
...
make_city_table_city(tromsoe_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Tromsoe 2019 til 2020.")
```
\
```{r plot_city_tromsoe, fig.width=8, fig.height=3}
...
```
\
```{r plot_city_trondheim, fig.width=8, fig.height=3}
