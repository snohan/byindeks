...
$$
\bar{d}(P, S) = \frac{1}{\left| P - S \right|} \sum_{p \in P - S} \min_{s \in S} d(p, s),
$$ {#eq-closeness_representation}

hvor $d(p, s)$ er den korteste vegen fra trafikklenke $p$ til trafikklenke $s$. For å beregne dette er det nødvendig å linjetransformere grafen slik at trafikklenker blir representert som noder. I grafsammenheng er avstander kun målt i antall lenker som må traverseres for å komme fra en node til en annen.
...
Hvilket område byindeksen skal gjelde for har noe å si for representativiteten. Ved å se på utvalget med de 24 trafikklenkene som har de opprinnelige byindekspunktene, kan vi sammenligne representativiteten av disse mellom en komplett og en sentral populasjon.
...
#| fig-cap: "Fordeling av funksjonsklasse i populasjon for sentralt område og utvalg med 24 punkt." 
#| message: false
#| warning: false
...
#| fig-cap: "Fordeling av funksjonsklasse i populasjon for komplett område og utvalg med 24 punkt." 
#| message: false
#| warning: false
...
I dette tilfellet med 24 punkt, ser vi at en sentral populasjon er bedre representert enn den komplette populasjonen, og det er som forventet.
 
I @tbl-trp_count_nj_24 oppsummeres andel trafikkarbeid i sentral populasjon og utvalg.

```{r}
#| label: tbl-trp_count_nj_24
#| tbl-cap:  "Statistikk for trafikklenker på Nord-Jæren (sentralt)</br>med utvalg på 24 punkt."
...
I @tbl-trp_count_nj_24_whole oppsummeres andel trafikkarbeid i komplett populasjon og utvalg.

```{r}
#| label: tbl-trp_count_nj_24_whole
#| tbl-cap:  "Statistikk for trafikklenker på Nord-Jæren (komplett)</br>med utvalg på 24 punkt."
