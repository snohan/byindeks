...
# Utvalg
I Trafikkdatasystemet er det generert opp trafikklenker fra det digitale vegnettet i NVDB, og disse er så beriket med flere aktuelle variabler:
...
For å finne ut om noen av de tilgjengelige variablene kan brukes til å forklare størrelsen og variasjonen til trafikklenkeindeksene, er det gjennomføret en korrelasjonanalyse.



For kategoriske forklaringsvariabler kan vi visuelt vurdere variasjonen ved hjelp av boksplott, mens for numeriske ser vi på Spearmans korrelasjonskoeffisient (som tar høyde for eventuelle ikke-lineære sammenhenger).

Det er ingen av de tilgjengelige variablene som har noen tydelig korrelasjon med trafikklenkeindeksen.

Finn variabler som sørger for spredning likevel, ved hjelp av faglig innsikt. Funksjonsklasse?
...
- bedre representativitet (korrelasjon eller geografisk spredning)
- mindre usikkerhet (grupper med likere verdier, lenker med stort trafikkarbeid)
- presise estimater i spesielle grupper (vilkårlig)

Hvis sammenhengen mellom trafikkarbeid og indeks ikke er lineær, er det en fordel å stratifisere trafikkarbeidet.

Er det viktigere med høy dekningsgrad (trafikkarbeid) enn representativitet? Jamfør omsetningsandel i bedrifter. Men det må også være geografisk spredning.

Stratifisere per måned, og dagtype. Vekte disse sammen - da får vi lavere usikkerhet?
Være strengere på at hver trafikklenkeindeks skal være upåvirket av vegnettsendringer.
...
## Fordeling av trafikklenker områder
