...
Hvor godt kan et utvalg sies å representere sin populasjon? Dette kan beskrives på ulike måter. En enkel måte er å sammenligne størrelsen på utvalg og populasjon. For en indeks kan vi enkelt beregne og sammenligne:

- antall trafikklenker med indekspunkt og antall trafikklenker i populasjonen
- andel av populasjonens trafikklenker som er med i utvalget
- samlet trafikkarbeid i henholdsvis utvalg og populasjon
- andel av populasjonens trafikkarbeid som er med i utvalget

Dette kan gjøres for hver funksjonsklasse.

En annen måte å sammenligne utvalg og populasjon på er å benytte en variabel som finnes på alle enheter i populasjonen og sammenligne fordelingen av denne.

Når populasjonen har en grafstruktur, kan et mål for utvalgets spredning i grafen beregnes.


## Fordeling av trafikklenker
Trafikklenkenes trafikkarbeid kan fordeles etter funksjonsklasse. Ved å sammenligne utvalgets fordeling med populasjonens fordeling, vil graden av likhet være et mål på representativitet. Slike føyningsmål ("goodness of fit") fra for eksempel Kolmogorov-Smirnov-testen gir ett tall som er den største avstanden mellom to fordelinger. Et avstandsmål som summerer opp "hele" avviket mellom to fordelinger er å foretrekke. Her er det sett på to ulike måter å beregne forskjellen på. 

Den ene måten kalles "total variation distance" (TVD) og beregnes ved først å finne den absolutte forskjellen mellom utvalget $S$ og populasjonen $P$ sine andeler trafikkarbeid for hver funksjonsklasse $k$, for så å summere disse for alle funksjonsklassene og til slutt dele på to. Matematisk kan dette skrives slik:
