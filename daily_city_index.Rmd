...
data_this_year_to <- "2021-02-15T00:00:00+01:00"
...
## Bergen
```{r plot_brg, fig.width=6, fig.height=6, fig.cap="Estimert endring i trafikk i Bergensområdet."}
city_index %>% 
...
## Nord-Jæren
```{r plot_nrj, fig.width=6, fig.height=6, fig.cap="Estimert endring i trafikk på Nord-Jæren."}
city_index %>% 
...
## Osloområdet
```{r plot_osl, fig.width=6, fig.height=6, fig.cap="Estimert endring i trafikk i Osloområdet."}
city_index %>% 
...
## Trondheim
```{r plot_trd, fig.width=6, fig.height=6, fig.cap="Estimert endring i trafikk i Trondheim."}
city_index %>% 
...
## Tromsø
```{r plot_trs, fig.width=6, fig.height=6, fig.cap="Estimert endring i trafikk i Tromsø."}
city_index %>% 
