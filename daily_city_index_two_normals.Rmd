...
# Daily traffic ####
data_this_year_from <- "2021-04-26T00:00:00+02:00"
data_this_year_to <- "2021-05-24T00:00:00+02:00"
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Bergensområdet", -30, 50)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Nord-Jæren", -30, 50)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Osloområdet", -30, 50)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Trondheim", -30, 50)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Tromsø", -30, 50)
```
