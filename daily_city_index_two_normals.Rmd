...
data_this_year_to <- "2021-04-26T00:00:00+02:00"
...
trp_index_this <- get_trp_index_for_weeknumber(16, trps, trp_index)

trp_index_2020_this <- get_trp_index_for_weeknumber(16, trps, trp_index_2020)
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Tromsø", -70, 51)
```
