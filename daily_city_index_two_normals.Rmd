...
data_this_year_to <- "2021-03-22T00:00:00+01:00"
...
trp_index_9 <- get_trp_index_for_weeknumber(9, trps, trp_index)
trp_index_10 <- get_trp_index_for_weeknumber(10, trps, trp_index)
trp_index_11 <- get_trp_index_for_weeknumber(11, trps, trp_index)

trp_index_9_2020 <- get_trp_index_for_weeknumber(9, trps, trp_index_2020)
trp_index_10_2020 <- get_trp_index_for_weeknumber(10, trps, trp_index_2020)
trp_index_11_2020 <- get_trp_index_for_weeknumber(11, trps, trp_index_2020)
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Bergensområdet", -15, 30)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Nord-Jæren", -15, 30)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Osloområdet", -15, 30)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Trondheim", -15, 30)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Tromsø", -15, 30)
```
