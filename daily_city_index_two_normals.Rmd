...
points_to_exclude <- c("18573V444291", # Fjellsrud
                       ...
                       "59675V319722", # Brueland
                       "49530V804761", # Osterøy - Trengereid
                       "58509V804762", # Rampe Arna til Osterøy
                       "17961V72812" # Holtermannsvegen
)
...
# Leirbrua
# 18.06.2020, 11:00 - 11.09.2020, 00:00
```
...
# Daily traffic ####
data_this_year_from <- "2021-08-16T00:00:00+02:00"
data_this_year_to <- "2021-09-13T00:00:00+02:00"
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Bergensområdet", -10, 20)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Nord-Jæren", -10, 20)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Osloområdet", -10, 20)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Trondheim", -10, 20)
```
...
dplyr::bind_rows(city_index,
  ...
  make_daily_dodged_bar_plot("Tromsø", -10, 20)
```
