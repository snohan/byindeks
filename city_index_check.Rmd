...
# Trondheim 960, uoffisiell   10 Snorre


# Choose
index_year <- 2021
index_month <- 11 # latest published
city_number <- 960
# End choose
...
pointindex_prepared_all <- 
  ...
  dplyr::left_join(this_citys_trps_all_adt_final) %>% 
  dplyr::mutate(
...
pointindex_prepared_all_wide_total_index <- 
  pointindex_prepared_all %>% 
  dplyr::select(name, road_category_and_number, adt, month, index_total_p) %>% 
