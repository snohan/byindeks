...
## Gjennomgangstrafikk
Gjennomgangstrafikk skal ikke inngå i målingen av om nullvekstmålet oppnås. Datagrunnlaget for byindeksen, som består av trafikkregistreringer i punkt, har ingen informasjon om hvilke kjøretøy som kun kjører gjennom området. For å kunne filtrere vekk gjennomgangstrafikk må det suppleres med data om trafikk på utvlagte kjøreruter.
