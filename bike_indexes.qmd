...
# Hvor har vi sykkelindeks?
Det er i dag `r nrow(index_info)` byer som har sykkelindeks, som vist i @fig-map.

```{r}
#| label: fig-map
#| fig-cap: "Byer med sykkelindeks. I parentes angis startår og antall sykkelregistreringspunkt."
#| fig-height: 10
