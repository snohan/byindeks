...
trps_and_links <- readr::read_rds("chosen_links_krs_2023.rds")
...
# Bakgrunn
Her er en oversikt over trafikkregistreringspunkt i Kristiansandområdet.


# Aktuelle punkt
Et høyt antall byindekspunkt kan gi god områderepresentativitet og flere punkt gir bidrag til lavere usikkerhet i byindeksen. Likevel er det flere grunner til at enkelte punkt ikke kan benyttes i indeksberegninger:

- Overrepresentasjon lokalt
- Ensidig påvirkning av større trafikkomlegginger
- Teknisk feil på registrering
- Høy andel gjennomgangstrafikk
...
```{r}
#| label: fig-map
#| fig-cap: "Trafikkregistreringspunkt i 2023."
...
leaflet(
  ...
  addLayersControl(
    overlayGroups = c("Aktuelle", "Ikke aktuelle"),
...
## Opprinnelige indekspunkt
I indeksen fra 2016 er det 36 indekspunkt, og noen av disse foreslås her at ikke videreføres, se @tbl-trps_2016.

```{r}
#| label: tbl-trps_2016
#| tbl-cap: "Opprinnelige punkt foreslått tatt ut."
