...
latest_month_name <- base::max(index_this_year_prepared$month_name) |> base::as.character()
...
index_this_year_prepared_wide_country %>%
  ...
  flextable::align(j = 3:number_of_columns, align = "right", part = "all") %>%
  bold(part = "header") %>%
  #font(fontname = "Lucida Sans Unicode", part = "all") %>%
  bg(bg = "#ED9300", part = "header") %>%
  border_remove() %>%
...
index_this_year_prepared_wide %>%
  ...
  flextable::align(j = 2:number_of_columns_2, align = "right", part = "all") %>%
  bold(part = "header") %>%
...
historic <- read.csv2("road_traffic_index_historic.csv") |> tibble::as_tibble()
...
#| tbl-cap: "Kumulativ trafikkutvikling i Noreg frå 1995 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling i Noreg frå 2005 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling i Noreg frå 2015 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling på fylkesvegar i Noreg frå 2015 til 2025."
#| ft.arraystretch: 0.9
...
historic_f_all_combinations %>% 
  ...
  set_header_labels(year = "År") %>%
  flextable::align(j = 2:flextable::ncol_keys(.), align = "right", part = "all") %>%
  bold(part = "header") %>%
  bg(bg = "#ED9300", part = "header") %>%
  border_remove() %>%
  hline_top(part = "header", border = borderline) %>%
...
#| tbl-cap: "Kumulativ trafikkutvikling på Europa- og riksvegar i Noreg frå 2015 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 1998 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2008 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2018 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 1998 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2008 til 2025."
#| ft.arraystretch: 0.9
...
#| tbl-cap: "Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2018 til 2025."
#| ft.arraystretch: 0.9
