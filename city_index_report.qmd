...
```{r}
#| label: tbl-trp-1
#| tbl-cap: "Trafikkregistreringspunktene som inngår i byindeksen. B er bomstasjon, T er trafikkregistreringspunkt."
#| ft.arraystretch: 0.9
...
```{r}
#| label: tbl-trp-2
#| tbl-cap: "Trafikkregistreringspunktene som inngår i byindeksen, del 2. B er bomstasjon, T er trafikkregistreringspunkt."
#| ft.arraystretch: 0.9
...
Så lenge pandemiperioden fra mars 2020 til februar 2022 inngår i treårsperioden, vil denne indeksen vise en verdi som er preget av det generelt lavere trafikknivået som var i disse årene.
...
Tre års glidende indeks glatter ut trender som er av kortere varighet, men som kan være synlige dersom den glidende indeksperioden beregnes for kortere spenn. Eksempelvis kan en økende trend i trafikken som har oppstått det siste året bli lite synlig i den tre års glidende indeksen dersom de to første årene var stabile. For å kunne si noe om hvilken utvikling den tre års glidende indeksen kan få framovr i tid, er det nyttig å se tilsvarende glidende indekser for perioder på ett og to år. Dette vises i figur @fig-rolling_indices.
...
visualize_rolling_indices(
  rolling_indices_long,
  caption_credit,
  "Estimert endring i trafikkmengde siste 1,2 og 3 år",
  paste0(
    "Sammenlignet med ",
    base_year
  )
...
<!-- `r stringr::str_replace(sprintf("%.1f", index_all_years), "\\.", ",")` %.  -->
<!-- Et 95 % konfidensintervall går fra  -->
<!-- `r stringr::str_replace(sprintf("%.1f", chained_index_ci_lower), "\\.", ",")` % til  -->
<!-- `r stringr::str_replace(sprintf("%.1f", chained_index_ci_upper), "\\.", ",")` %. -->
