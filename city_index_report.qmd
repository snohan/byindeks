...
# Kristiansandsregionen19953 (2023) 12
# Nedre Glomma 2023    18952 (2023) 12
  ...
  latest_36_ci_conclusion <-
    dplyr::case_when(
      latest_36_index$ci_lower < 0 & latest_36_index$ci_upper > 0 ~ 
        "Det er ikke med sikkerhet mulig å si om trafikken har økt eller ikke - trafikken er omtrent på samme nivå som i referanseåret.",
...
Indekstall som gjelder for lengre perioder enn to påfølgende år er beregnet som en kjedet indeks av årsindeksene.^[En kjedet indeks er en multiplikasjon av indekser på desimalform hvor en indeks på 1 tilsvarer ingen endring.]

Tabell @tbl-city_index viser den årlige endringen, samt prosentvis endring sammenlignet med referanseåret.
