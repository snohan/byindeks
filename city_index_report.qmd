  ...
  all_point_info |> 
    ...
    flextable::footnote(
      ...
      value = flextable::as_paragraph(
        c("A er AutoPASS bomstasjon, T er trafikkregistreringspunkt.")
      ),
      ref_symbols = c("a"),
      part = "header"
    ) |>
...
Byindeksen skal estimere endring i persontransport med bil, men det er også en del næringstransport og mobil tjeneseyting med samme type biler. I datagrunnlaget er det ikke mulig å skille på reiseformålet til de registrerte bilene. 

Transportøkonomisk instiutt har i rapporten "Varebiler og mobile tjenesteytere: Andel mobile tjenestereiser i de fire største norske byområdene" sett på fordeling av reiseformål for trafikk med lette kjørtøy:
