...
# Tromsø                 961 (2016) 12
# Nord-Jæren             952 (2017) 12r
# Bergen                8952 (2018) 12r
# Oslo                   959 (2018) 12r
...
tbl_cap_all_36 <-
  paste0(
    "Tre års glidende indeks. Antall punkt som oppgis er hvor mange av de ",
    nrow(all_point_info),
...
```{r}
#| label: tbl-trp-1
#| tbl-cap: "Trafikkregistreringspunktene som inngår i byindeksen, del 1. B er bomstasjon, T er trafikkregistreringspunkt."
#| ft.arraystretch: 0.9
...
Kartet i figur @fig-map_trp viser plasseringen av trafikkregistreringspunktene. Punktet Meådalen på Ev 14 mellom Stjørdal og Meråker er utelatt fra kartvisningen.
...
#| tbl-cap: "Tre års glidende indeks for gamle Kristiansand kommune, del 1."
...
```{r}
#| label: tbl-trp_36_kommune-2
#| tbl-cap: "Tre års glidende indeks  for gamle Kristiansand kommune, del 2."
...
### Trafikken på Ev 18
Til sammenligning viser tabellen nedenfor endringen i trafikkmengden for lette kjøretøy på Ev 18 i samme periode.
