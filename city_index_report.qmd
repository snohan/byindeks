...
# Buskerudbyen          1952 (2016) 12 må oppdateres
# Grenland               955 (2016) 12 må oppdateres
# Kristiansand og omegn  957 (2016) 12 må oppdateres
...
# TODO:
# Eget avsnitt om datakvalitet
#   MC
#   Lengde versus vekt og klasse
#   Kø
# Eget avsnitt om næringstransport og gjennomgangstrafikk
```
...
```{r}
#| label: tbl-trp-4
#| tbl-cap: "Trafikkregistreringspunktene som inngår i byindeksen, del 4."
...
Nullvekstmålet skal måles ved at trafikkutviklingen vurderes på et treårs glidende snitt, jf. brev fra Samferdselsdepartementet til de fire største byområdene datert 11.12.2019. Måloppnåelsen gjelder avtaleperioden sett under ett, som betyr at det er trafikknivået i referanseåret `r base_year` det skal sammenlignes med. Det skal være netto nullvekst i perioden.
...
```{r}
#| label: tbl-trp_36-2
#| tbl-cap: "Tre års glidende indeks, del 2."
