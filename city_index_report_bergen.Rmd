...
```{r plot_city_index, fig.width=6, fig.height=5}
set.seed(123)
...
ggplot() +
  ...
  labs(x = NULL, y = "Endring i trafikkmengde (%)",
       caption = "Data: Statens vegvesen, Vestland fylkeskommune") +
...
```{r point_graph, fig.width=6, fig.height=10}
...
ggplot2::ggplot() +
  ...
  ggtitle(label = "ÅDT og endring i trafikkmengde",
          subtitle = "Fra 2017 til oktober 2020") +
  coord_flip() +
  scale_size(name = "ÅDT") +
  ...
  labs(caption = "Data: Statens vegvesen, Vestland fylkeskommune")
