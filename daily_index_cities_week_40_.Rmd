...
week_2019_to <- "2020-01-06T00:00:00+01:00"

week_2020_from <- "2020-09-28T00:00:00+02:00"
week_2020_to <- "2021-01-04T00:00:00+01:00"
...
trp_dt_52 <- calculate_trp_index(dt_2019_51, dt_2020_52)
trp_dt_jul <- calculate_trp_index_movable_days(
  dt_2019_jul, dt_2020_jul)
trp_dt_53 <- calculate_trp_index(dt_2020_1, dt_2020_53_last)
...
city_dt_52 <- calculate_city_index(dt_2019_51, dt_2020_52) %>% 
  mutate(weekno = "52")
...
city_dt_jul <- inner_join(dt_2019_jul, dt_2020_jul,
  ...
  select(city_area_name, weekday, index) %>% 
  arrange(weekday, city_area_name) %>% 
  tidyr::pivot_wider(names_from = weekday,
                     values_from = index)

city_dt_53 <- calculate_city_index(dt_2020_1, dt_2020_53_last) %>% 
  mutate(weekno = "53")
...
oslo_og_akershus_dt_2019_2020 <- city_dt_2019_2020_weeks %>% 
  filter(city_area_name == "Oslo og Viken") %>% 
...
For å få et best mulig bilde av trafikkutviklingen sammenlignes her døgntrafikken sammenlignes med tilsvarende døgntrafikk i samme uke i 2019.
...
Nedenfor vises daglig endring i trafikk i de største byområdene.

## Bergen
```{r table_city_bergen}
make_city_table_city(bergen_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Bergen.")
```

<br>

```{r plot_city_bergen, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Bergen."}
...
make_city_table_city(bodo_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Bodø.")
```

<br>

```{r plot_city_bodo, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Bodø."}
...
make_city_table_city(nord_jaeren_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Nord-Jæren.")
```

<br>

```{r plot_city_nord_jaeren, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Nord-Jæren."}
...
make_city_table_city(oslo_og_akershus_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Oslo og Viken.")
```

<br>

```{r plot_city_oslo, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Oslo og Viken."}
...
make_city_table_city(tromsoe_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Tromsø.")
```

<br>

```{r plot_city_tromsoe, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Tromsø."}
...
make_city_table_city(trondheim_dt_2019_2020,
                "Prosentvis endring i trafikkmengde i Trondheim.")
```

<br>

```{r plot_city_trondheim, fig.width=6, fig.height=8, fig.cap="Prosentvis endring i trafikkmengde i Trondheim."}
