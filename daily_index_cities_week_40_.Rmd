...
week_2019_to <- "2019-11-18T00:00:00+02:00"

week_2020_from <- "2020-09-28T00:00:00+02:00"
week_2020_to <- "2020-11-16T00:00:00+02:00"
...
```
\
```{r plot_city_bergen, fig.width=8, fig.height=9}
...
```
\
```{r plot_city_bodo, fig.width=8, fig.height=9}
...
```
\
```{r plot_city_nord_jaeren, fig.width=8, fig.height=9}
...
```
\
```{r plot_city_oslo_og_akershus, fig.width=8, fig.height=9}
...
```
\
```{r plot_city_tromsoe, fig.width=8, fig.height=9}
...
```
\
```{r plot_city_trondheim, fig.width=8, fig.height=9}
