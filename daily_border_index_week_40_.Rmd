...
borderdata_2019_to <- "2019-12-16T00:00:00+02:00"

borderdata_2020_from <- "2020-09-28T00:00:00+02:00"
borderdata_2020_to <- "2020-12-14T00:00:00+02:00"
...
```{r plot_2019_2, fig.width=6, fig.height=5, fig.cap="Estimert endring i trafikk over riksgrensen, uke 46 - 50."}
border_base_2019 %>% 
  dplyr::filter(periode %in% c("Uke \n 46",
                               "Uke \n 47",
                               "Uke \n 48",
