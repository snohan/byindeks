...
# Daily traffic ####
borderdata_this_year_from <- "2021-06-21T00:00:00+02:00"
borderdata_this_year_to <- "2021-06-28T00:00:00+02:00"
...
border_trp_index_25 <- get_trp_index_for_weeknumber(25, border_trps, border_trp_index)
...
# border_trp_index_21 <- get_trp_index_for_weeknumber(21, border_trps, border_trp_index)
# border_trp_index_22 <- get_trp_index_for_weeknumber(22, border_trps, border_trp_index)
# border_trp_index_23 <- get_trp_index_for_weeknumber(23, border_trps, border_trp_index)
# border_trp_index_24 <- get_trp_index_for_weeknumber(24, border_trps, border_trp_index)

border_trp_index_2020_25 <- get_trp_index_for_weeknumber(25, border_trps, border_trp_index_2020)
...
# border_trp_index_2020_21 <- get_trp_index_for_weeknumber(21, border_trps, border_trp_index_2020)
# border_trp_index_2020_22 <- get_trp_index_for_weeknumber(22, border_trps, border_trp_index_2020)
# border_trp_index_2020_23 <- get_trp_index_for_weeknumber(23, border_trps, border_trp_index_2020)
# border_trp_index_2020_24 <- get_trp_index_for_weeknumber(24, border_trps, border_trp_index_2020)
...
border_trp_index_25 %>% 
  ...
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalperioden 2016 - 2019, uke 25 2021.")
```
...
#border_trp_index_18 %>% 
#  dplyr::select(-area_name) %>% 
#  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 18 2021.")
```
...
#border_trp_index_19 %>% 
#  dplyr::select(-area_name) %>% 
#  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 19 2021.")
```
...
#border_trp_index_20 %>% 
#  dplyr::select(-area_name) %>% 
#  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 20 2021.")
```
...
#border_trp_index_21 %>%
# dplyr::select(-area_name) %>%
# make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 21 2021.")
```
...
#border_trp_index_22 %>%
# dplyr::select(-area_name) %>%
# make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 22 2021.")
```
...
#border_trp_index_23 %>%
# dplyr::select(-area_name) %>%
# make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 23 2021.")
```
...
#border_trp_index_24 %>% 
#  dplyr::select(-area_name) %>% 
#  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 24 2021.")
```
