...
# Daily traffic ####
borderdata_this_year_from <- "2021-08-16T00:00:00+02:00"
borderdata_this_year_to <- "2021-10-11T00:00:00+02:00"
...
border_trp_index_33 <- get_trp_index_for_weeknumber(33, border_trps, border_trp_index)
border_trp_index_34 <- get_trp_index_for_weeknumber(34, border_trps, border_trp_index)
border_trp_index_35 <- get_trp_index_for_weeknumber(35, border_trps, border_trp_index)
border_trp_index_36 <- get_trp_index_for_weeknumber(36, border_trps, border_trp_index)
border_trp_index_37 <- get_trp_index_for_weeknumber(37, border_trps, border_trp_index)
border_trp_index_38 <- get_trp_index_for_weeknumber(38, border_trps, border_trp_index)
border_trp_index_39 <- get_trp_index_for_weeknumber(39, border_trps, border_trp_index)
border_trp_index_40 <- get_trp_index_for_weeknumber(40, border_trps, border_trp_index)

border_trp_index_2020_33 <- get_trp_index_for_weeknumber(33, border_trps, border_trp_index_2020)
border_trp_index_2020_34 <- get_trp_index_for_weeknumber(34, border_trps, border_trp_index_2020)
border_trp_index_2020_35 <- get_trp_index_for_weeknumber(35, border_trps, border_trp_index_2020)
border_trp_index_2020_36 <- get_trp_index_for_weeknumber(36, border_trps, border_trp_index_2020)
border_trp_index_2020_37 <- get_trp_index_for_weeknumber(37, border_trps, border_trp_index_2020)
border_trp_index_2020_38 <- get_trp_index_for_weeknumber(38, border_trps, border_trp_index_2020)
border_trp_index_2020_39 <- get_trp_index_for_weeknumber(39, border_trps, border_trp_index_2020)
border_trp_index_2020_40 <- get_trp_index_for_weeknumber(40, border_trps, border_trp_index_2020)
...
border_trp_index_33 %>% 
  ...
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalperioden 2016 - 2019, uke 33 2021.")
```
...
border_trp_index_34 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 34 2021.")
```
...
border_trp_index_35 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 35 2021.")
```
...
border_trp_index_36 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 36 2021.")
```
...
border_trp_index_37 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 37 2021.")
```
...
border_trp_index_38 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 38 2021.")
```
...
border_trp_index_39 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 39 2021.")
```
...
border_trp_index_40 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 40 2021.")
```
<!--
-->