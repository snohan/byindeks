...
# Daily traffic ####
borderdata_this_year_from <- "2021-11-22T00:00:00+01:00"
borderdata_this_year_to <- "2021-12-13T00:00:00+01:00"
...
border_trp_index_49 <- get_trp_index_for_weeknumber(49, border_trps, border_trp_index)
#border_trp_index_50 <- get_trp_index_for_weeknumber(50, border_trps, border_trp_index)
...
border_trp_index_2020_49 <- get_trp_index_for_weeknumber(49, border_trps, border_trp_index_2020)
#border_trp_index_2020_50 <- get_trp_index_for_weeknumber(50, border_trps, border_trp_index_2020)
...
border_trp_index_47 %>% 
  ...
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalperioden 2016 - 2019, uke 47 2021.")
```
...
border_trp_index_49 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 49 2021.")
```
...
# border_trp_index_50 %>%
# dplyr::select(-area_name) %>%
# make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 50 2021.")
```
