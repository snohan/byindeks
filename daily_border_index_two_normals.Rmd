...
borderdata_this_year_to <- "2021-08-16T00:00:00+02:00"
...
border_trp_index_31 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 31 2021.")
```
...
border_trp_index_32 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 32 2021.")
```
<!--
-->