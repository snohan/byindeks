...
borderdata_this_year_to <- "2021-08-02T00:00:00+02:00"
...
border_trp_index_26 <- get_trp_index_for_weeknumber(26, border_trps, border_trp_index)
border_trp_index_27 <- get_trp_index_for_weeknumber(27, border_trps, border_trp_index)
border_trp_index_28 <- get_trp_index_for_weeknumber(28, border_trps, border_trp_index)
border_trp_index_29 <- get_trp_index_for_weeknumber(29, border_trps, border_trp_index)
border_trp_index_30 <- get_trp_index_for_weeknumber(30, border_trps, border_trp_index)
# border_trp_index_31 <- get_trp_index_for_weeknumber(31, border_trps, border_trp_index)
# border_trp_index_32 <- get_trp_index_for_weeknumber(32, border_trps, border_trp_index)

border_trp_index_2020_25 <- get_trp_index_for_weeknumber(25, border_trps, border_trp_index_2020)
border_trp_index_2020_26 <- get_trp_index_for_weeknumber(26, border_trps, border_trp_index_2020)
border_trp_index_2020_27 <- get_trp_index_for_weeknumber(27, border_trps, border_trp_index_2020)
border_trp_index_2020_28 <- get_trp_index_for_weeknumber(28, border_trps, border_trp_index_2020)
border_trp_index_2020_29 <- get_trp_index_for_weeknumber(29, border_trps, border_trp_index_2020)
border_trp_index_2020_30 <- get_trp_index_for_weeknumber(30, border_trps, border_trp_index_2020)
# border_trp_index_2020_31 <- get_trp_index_for_weeknumber(31, border_trps, border_trp_index_2020)
# border_trp_index_2020_32 <- get_trp_index_for_weeknumber(32, border_trps, border_trp_index_2020)
...
border_trp_index_26 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 26 2021.")
```
...
border_trp_index_27 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 27 2021.")
```
...
border_trp_index_28 %>%
 dplyr::select(-area_name) %>%
 make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 28 2021.")
```
...
border_trp_index_29 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 29 2021.")
```
...
border_trp_index_30 %>%
  dplyr::select(-area_name) %>%
  make_border_trp_table("Estimert endring i trafikk, avvik fra normalen i perioden 2016 - 2019, uke 30 2021.")
```
