...
get_border_trp_index_for_weeknumber_2020 <- function(weekno) {

  week_data <- border_trp_index_2020 %>% 
  dplyr::select(trp_id, ukedag, ukenr, index) %>% 
  dplyr::filter(ukenr == weekno) %>% 
  tidyr::pivot_wider(names_from = ukedag,
                     values_from = index)
...
border_trp_index_11 <- get_border_trp_index_for_weeknumber(11)
...
border_trp_index_9_2020 <- get_border_trp_index_for_weeknumber_2020(9)
border_trp_index_10_2020 <- get_border_trp_index_for_weeknumber_2020(10)
border_trp_index_11_2020 <- get_border_trp_index_for_weeknumber_2020(11)
