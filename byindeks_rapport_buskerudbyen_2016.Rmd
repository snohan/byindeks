...
road_lengths <- read_road_length_csv("road_lengths/buskerudbyen_road_lengths.csv")
...
city_monthly <- 
  read.csv2("data_indexpoints_tidy/byindeks_maanedlig_buskerudbyen_2016.csv")

city_monthly_uten_e18 <-
  read.csv2("data_indexpoints_tidy/byindeks_maanedlig_buskerudbyen_uten_e18_2016.csv")

city_36_month <- 
  read.csv2("data_indexpoints_tidy/byindeks_36_maaneder_buskerudbyen_2016.csv")

city_36_month_uten_e18 <- 
  read.csv2("data_indexpoints_tidy/byindeks_36_maaneder_buskerudbyen_uten_e18_2016.csv")
...
Buskerudbyen omfatter kommunene Drammen, Kongsberg, Øvre Eiker og Lier. Veglengder fordelt på vegkatori er oppsummert i tabellen nedenfor.
...
En tilsvarende byindeks hvor punktene på E18 er utelatt, er vist i tabellene nedenfor.

```{r city_table_36_uten_e18}
create_city_36_index_table(city_36_month_uten_e18)
# TODO: CI
```
...
create_city_index_table(city_info_uten_e18) %>% 
...
I figuren nedenfor er spredningen i punktindeksene illustrert. Den horisontale grønne streken viser byindeksens samlede verdi for perioden 2016 - april 2020. Det lysegrønne området angir konfidensintervallet på 95 %-nivå.
...
Tilsvarende for alle punkter uten de på E18.

```{r monthly_uten_18}
create_monthly_city_index_table(city_monthly_uten_e18)%>% 
  set_caption("Estimert endring i trafikkmengde uten E18.")
```
