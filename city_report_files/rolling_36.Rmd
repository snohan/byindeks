...
Hvilke byindekspunkter som er med i datagrunnlaget for den nyeste tre års glidende indeksen er vist i tabell @tbl-trp_36.

```{r}
#| label: tbl-trp_36
#| tbl-cap: "Byindekspunktene som bidrar til den nyeste tre års glidende indeksen."
#| ft.arraystretch: 1
...
readr::read_rds(file = paste0("data_indexpoints_tidy/rolling_trp_indices_", city_number, ".rds"))[[2]] |> 
  ...
  dplyr::arrange(road_category_and_number, name) |> 
  flextable::flextable() |>
  colformat_double(
    j = c("trp_index_p"),
    digits = 1
  ...
  set_header_labels(
    ...
    adt = paste0("ÅDT ", latest_complete_year$year),
