...
# AADT coverage and length_quality previous year
trp_aadts <- trp_for_vti_tidy$trp_id %>% 
  get_aadt_for_trp_list() 

saveRDS(trp_aadts, file = "trp_aadt.rds")

#trp_aadts <- readRDS("trp_aadt.rds")
