...
road_lengths <- read_road_length_csv("road_lengths/tromso_road_lengths.csv")
...
city_36_month <- 
  read.csv2("data_indexpoints_tidy/byindeks_36_maaneder_tromso_2016.csv")
...
Dagens byindeks gjelder for byområdet Tromsø. Veglengder for hele Tromsø kommune er vist i tabellen nedenfor.
