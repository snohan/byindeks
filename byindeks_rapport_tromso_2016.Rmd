...
all_point_info <- 
  read.csv2("data_indexpoints_tidy/indekspunkt_tromso_2016.csv")

city_info <-
    read.csv2("data_indexpoints_tidy/byindeks_tromso_2016.csv")

city_monthly <- 
  read.csv2("data_indexpoints_tidy/byindeks_maanedlig_tromso_2016.csv")
