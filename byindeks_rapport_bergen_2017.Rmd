...
road_lengths <- read.csv2("road_lengths/bergen_road_lengths.csv") %>% 
...
Dagens byvekstavtale gjelder for kommunene Bergen, Askøy, Alver og Bjørnafjorden. Veglengder fordelt på vegkatori er vist i tabellene nedenfor.

Lengden på vegnettet gjelder per 1. januar 2020, og omfatter kun bilveg. Lengde på kryssystem og sideanlegg er utelatt [^1]. 

[^1]: Videre filtrering: kun topologinivå VT+VTKB, kun vegtype kanalisert veg og enkel bilveg, kun veglenketype "hoved". Adskilte løp: kun "Nei" og "Med" - dette som en enkel måte å unngå dobbelttelling av f.eks. toløpstuneller på.
...
## Endring i rullerende treårsperiode

Når månedsindeks er beregnet gjennom tre år eller lenger, beregnes en rullerende treårsindeks. Den oppdateres månedlig. Den første treårsindeksen inkluderer månedsindeksene fra og med januar 2017 til og med desember 2019.
