...
road_lengths <- read_road_length_csv("road_lengths/grenland_road_lengths.csv")

all_point_info <- 
  read.csv2("data_indexpoints_tidy/indekspunkt_grenland_2016.csv")

city_info <-
    read.csv2("data_indexpoints_tidy/byindeks_grenland_2016.csv")

city_monthly <- 
  read.csv2("data_indexpoints_tidy/byindeks_maanedlig_grenland_2016.csv")

city_36_month <- 
  read.csv2("data_indexpoints_tidy/byindeks_36_maaneder_grenland_2016.csv")
...
Kartet nedenfor viser endringen i byindekspunktene fra referanseåret 2016 til og med april 2020.

```{r map_trp_index, cache=FALSE}
...
I figuren nedenfor er spredningen i punktindeksene illustrert. Den horisontale grønne streken viser byindeksens samlede verdi for perioden 2016 - 2020.
