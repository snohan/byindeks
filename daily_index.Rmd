...
output: 
  word_document:
    reference_docx: svv_notatmal2.docx
    toc: true
    toc_depth: 2
    fig_caption: true
    fig_width: 7
...
week_2019_to <- "2019-04-01T00:00:00+01:00"

week_2020_from <- "2020-02-24T00:00:00+01:00"
week_2020_to <- "2020-03-24T00:00:00+01:00"
...
trp_dt_201912_202013 <- calculate_trp_index(dt_2019_13, dt_2020_13)
...
city_dt_2020_10_13 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 10 til uke 13 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
city_dt_2020_10_13 %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Prosentvis endring i trafikkmengde fra uke 10 til uke 13 i 2020.")
```
...
city_dt_2020_09_13 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 9 til uke 13 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
city_dt_2020_09_13 %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Prosentvis endring i trafikkmengde fra uke 9 til uke 13 i 2020.")
```
...
city_dt_201913_202013 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 13 2019 til uke 13 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
city_dt_201913_202013 %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Prosentvis endring i trafikkmengde fra uke 13 2019 til uke 13 2020.")
```
