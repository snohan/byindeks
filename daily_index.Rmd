...
week_2019_to <- "2019-04-22T00:00:00+01:00"

week_2020_from <- "2020-02-24T00:00:00+01:00"
week_2020_to <- "2020-04-03T00:00:00+01:00"
...
city_dt_2020_10_14 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 10 til uke 14 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
city_dt_2020_09_14 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 9 til uke 14 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
city_dt_201914_202014 %>%
  ...
  ylab("Endring i trafikkmengde (%)\n") +
  ggtitle(label = "Daglig endring i trafikkmengde",
          subtitle = "Fra uke 14 2019 til uke 14 i 2020") +
  theme(strip.text.y = element_text(angle = 180),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
