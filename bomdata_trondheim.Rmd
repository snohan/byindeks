...
bomdata_trondheim_maanedlig <- 
  read.csv2(
    "H:/Programmering/R/byindeks/data_index_raw/bomdata_trondheim_maanedlig_new.csv",
    stringsAsFactors = FALSE
  ) %>% 
  dplyr::mutate(
    aar_maaned = lubridate::ymd(aar_maaned)
  )
...
areaplot_by_class <- function(data_to_plot, station_no_from, station_no_to) {
  ...
  data_to_plot %>% 
    ...
    ggtitle(
      label = "Relativ andel kjøretøy i klasser", 
