...
source("H:/Programmering/R/road_traffic_index/trafikkindeks_metode/chain.R")
...
# TODO: chained index that includes toll data
...
## Kjedet indeks med data fra bomstasjoner
Nord-Jæren fikk nye bomstasjoner 1. oktober 2018. Det er derfor ønskelig å sammenligne trafikken med det siste året før dette, altså perioden fra og med oktober 2017 til og med september 2018. Her vises resultater fra et regneeksempel hvor dette året er brukt som referanseår, samt at data fra bomstasjonene blir faset inn i indekskjeden fra og med det året de ble satt i drift.
...
## Sammenligning av ett- og treårs glidende indeks

```{r}
#| label: plot_12_36_compare
#| fig-cap: "Sammenligning av ett- og treårs glidende indeks"
#| fig-width: 10
#| fig-height: 7
...
fig_improved_1y_3y <-
  ...
  dplyr::mutate(
    area = base::factor(area, levels = c("Nord-Jæren", "Bergensområdet", "Osloområdet", "Trondheimsområdet"))
  ) |> 
