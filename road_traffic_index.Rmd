...
Tabellen nedanfor viser trafikkutviklinga for heile Noreg. Den statistiske spreiinga i datagrunnlaget er gitt av standardavviket.
...
index_2020_prepared %>%
  ...
  dplyr::select(area_name, length_range, index_p, standard_deviation) %>%
  flextable::flextable() %>%
