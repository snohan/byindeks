...
index_2020_prepared_wide <- index_2020_prepared %>% 
...
index_2020_prepared_wide_country <- index_2020_prepared %>% 
  dplyr::filter(area_type == "COUNTRY",
                period == "month",
                length_range == "alle",
                road_category == "Europa-, riks- og fylkesveg"#,
...
Kort summert har trafikkutviklinga vore som følgjer:
...
index_2020_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Endring i trafikkmengde i heile Noreg frå 2019 til 2020, per vegkategori.",
...
index_2020_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Endring i trafikkmengde i heile Noreg frå 2019 til 2020, per døgntype.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_2020_prepared_wide_country %>%
  flextable::flextable() %>%
  colformat_double(j = 3:14, digits = 1) %>%
  set_header_labels(area_name = "Område",
                    day_type = "Døgntype") %>%
  align(j = 3:14, align = "right", part = "all") %>%
  bold(part = "header") %>%
  fontsize(size = 9, part = "all") %>%
  font(fontname = "Lucida Sans Unicode", part = "all") %>%
  bg(bg = "#ED9300", part = "header") %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Endring i trafikkmengde i Noreg for kvar månad frå 2019 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_2020_prepared %>%
  ...
  ggtitle("Endring i trafikkmengde per vegkategori",
          subtitle = "2020 samanlikna med 2019") +
...
index_2020_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Endring i trafikkmengde i landsdelane frå 2019 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_2020_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Endring i trafikkmengde i fylka frå 2019 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_2020_prepared_wide %>%
  flextable::flextable() %>%
  colformat_double(j = 2:13, digits = 1) %>%
  set_header_labels(area_name = "Fylke") %>%
  align(j = 2:13, align = "right", part = "all") %>%
  bold(part = "header") %>%
  fontsize(size = 9, part = "all") %>%
  font(fontname = "Lucida Sans Unicode", part = "all") %>%
  bg(bg = "#ED9300", part = "header") %>%
