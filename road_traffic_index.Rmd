...
historic_f_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling på fylkesvegar i Noreg frå 2015 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_er_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling på Europa- og riksvegar i Noreg frå 2015 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 1998 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2008 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2018 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 1998 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2008 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2018 til 2020.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
