...
## Definisjonar
**Helgedøgn**: Laurdag og søndag kl. 00:00-23:59, alle offentlege fridagar og jule- og nyårskvelden. <br>
**Yrkedøgn**: Alle døgn minus helgedøgn.

**Lette køyretøy**: Lengde < 5,6 meter <br>
**Tunge køyretøy**: Lengde ≥ 5,6 meter


# Trafikkutviklinga i Noreg

Kort oppsummert har trafikkutviklinga vore som følgjer: <br>
...
Trafikkauken for ulike vegkategoriar: <br>
Riksvegar i alt (Ev + Rv): `r index_so_far_this_year_r` %. <br>
...
index_2020_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Estimert samla endring i trafikkmengde frå 2019 til 2020.",
...
```{r lineplot, fig.width=6.5, fig.height=9, fig.cap="Trafikkutvikling i Norge per måned."}
index_2020_prepared %>%
