...
points <- get_points() %>%
  ...
  dplyr::left_join(counties, by = "county_name")
...
#index_this_year <- get_published_road_traffic_index_for_months(962, 2019, 12)
#write.csv2(index_this_year, file = "spesialuttak/vegtrafikkindeks_2019.csv",
#           row.names = F)
...
less_or_more_month <- dplyr::if_else(index_this_month$index_p < 0, "mindre", "meir")
...
less_or_more_so_far <- dplyr::if_else(index_so_far_this_year_all$index_p < 0, "mindre", "meir")
...
index_this_year_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption(paste0("Endring i trafikkmengde i heile Noreg i januar-", latest_month_name,", frå 2020 til 2021, per vegkategori."),
...
index_this_year_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption(paste0("Endring i trafikkmengde i heile Noreg i januar-", latest_month_name,", frå 2020 til 2021, per døgntype."),
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_this_year_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption(paste0("Endring i trafikkmengde i landsdelane i januar-", latest_month_name, ", frå 2020 til 2021."),
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
index_this_year_prepared %>%
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption(paste0("Endring i trafikkmengde i fylka i januar-", latest_month_name, ", frå 2020 til 2021."),
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_f_all_combinations <- calculate_all_index_chain_combinations(historic_f)

historic_er <- historic %>% 
  dplyr::filter(length_range == "alle",
                road_category == "ER") %>% 
  dplyr::mutate(index_i = 1 + (index_p / 100),
                cum_index_i = round(cumprod(index_i) * 100, digits = 1)
...
historic_er_all_combinations <- calculate_all_index_chain_combinations(historic_er)
...
historic_l_combinations <- calculate_all_index_chain_combinations(historic_l)

historic_h <- historic %>% 
  dplyr::filter(length_range == "tunge",
                road_category == "ERF") %>% 
  dplyr::mutate(index_i = 1 + (index_p / 100),
                cum_index_i = round(cumprod(index_i) * 100, digits = 1)
                ) %>% 
...
historic_h_combinations <- calculate_all_index_chain_combinations(historic_h)
...
historic_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling i Noreg frå 1995 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling i Noreg frå 2005 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling i Noreg frå 2015 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_f_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling på fylkesvegar i Noreg frå 2015 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_er_all_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling på Europa- og riksvegar i Noreg frå 2015 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 1998 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2008 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_l_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for lette køyretøy i Noreg frå 2018 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 1998 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2008 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
...
historic_h_combinations %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>%
  set_caption("Kumulativ trafikkutvikling for tunge køyretøy i Noreg frå 2018 til 2021.",
               autonum = table_numbers,
               style = "Tabelltekst")
```
