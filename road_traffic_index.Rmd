...
index_2020 <- get_published_road_traffic_index_for_months(962, 2020, 7)
...
index_2020_upper_lower  %>% 
  ...
  set_header_labels(area_name = "Område", month_name = "Måned", year = "År", length_range = "Kjøretøyklasse",
...
index_2020_upper_lower %>%
  ...
  set_header_labels(area_name = "Område", month_name = "Måned", year = "År", 
                    road_category = "Vegkategori", length_range = "Kjøretøyklasse",
                    index_lower = "Endring i trafikkmengde (%)") %>%
  add_header_row(values = c("", "", "", "", "", "Nedre", "Estimat", "Øvre"), top = FALSE) %>% 
