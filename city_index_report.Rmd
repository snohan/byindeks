...
2017 til `r latest_month` 2020 til å være 
...
Kartet nedenfor viser endringen i byindekspunktene fra referanseåret 2017 til og med `r latest_month` 2020.
...
I figuren nedenfor er spredningen i punktindeksene illustrert. Den horisontale grønne streken viser byindeksens samlede verdi for hele perioden 2017 - `r latest_month` 2020.

\newline

```{r point_graph, fig.width=6, fig.height=7}
all_point_info_index <- all_point_info %>% 
  dplyr::filter(!is.na(index)) 

subtitle_here <- paste0("Fra 2017 til ", latest_month, " 2020")
...
```{r child = 'trafikkforhold_952.Rmd'}
```
