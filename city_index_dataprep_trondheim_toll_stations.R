...
pointindex_22_all <-
  get_published_pointindex_for_months_trondheim(city_number, 2022, 12)
pointindex_23_all <-
  get_published_pointindex_for_months_trondheim(city_number, 2023, index_month)
