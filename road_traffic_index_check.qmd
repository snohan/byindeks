...
events <- readr::read_rds("H:/my_data/events_20251202.rds")
...
links_with_events_and_pointindex_1 |> map_pointindex_and_events()
```
...
links_with_events_and_pointindex_2 |> map_pointindex_and_events()
```
