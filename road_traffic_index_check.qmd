...
month_start <-
  paste0(
      index_year - 1,
      "-",
      stringr::str_pad(index_month + 1, width = 2, pad = "0"),
      "-01"
    ) |> 
...
# Join ----
# Might be heavy, may be reduced to do this by county
events_and_links <-
  sf::st_join(
    events_overlaps,
    links |> 
