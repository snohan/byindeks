...
map_links_for_index_check(index_year - 1, index_year, index_month + 1, point_index_new_prepared_1, 4)
```
...
map_links_for_index_check(index_year - 1, index_year, index_month + 2, point_index_new_prepared_2, 4)
```
