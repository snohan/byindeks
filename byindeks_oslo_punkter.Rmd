...
Tabell og kart over byindekspunktene.
...
```{r mapshow, echo=FALSE, cache=FALSE}
#map.oslo
m <- leaflet() %>% setView(lng = 10.45, lat = 63.45, zoom = 12)
#m %>% addProviderTiles(providers$Esri.WorldStreetMap)
m %>% addTiles(urlTemplate = "https://nvdbcache.geodataonline.no/arcgis/rest/services/Trafikkportalen/GeocacheTrafikkJPG/MapServer/tile/{z}/{x}/{y}")
```
