...
kommunepunkter_trondheim <- bind_rows(kommunepunkter_trondheim_med,
  ...
  filter(Navn != "Innherredsveien vest for Persaunvegen")
...
# Tabell
byindekspunkter_trondheim <- kommunepunkter_trondheim  %>% 
  filter(Byindeks == "Ja") %>% 
  left_join(adt) %>% 
...
# write.csv2(byindekspunkter_trondheim, file = "byindekspunkter_trondheim_20190307.csv",
#            row.names = F)

byindekspunkter_trondheim %>% 
