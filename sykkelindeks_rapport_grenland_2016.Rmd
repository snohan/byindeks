...
# Bakgrunn
Statens vegvesens sykkelregisteringsstasjoner leverer data på som kan benyttes til å beregne en indeks, det vil si et estimat på endring i trafikkmengde, ved hjelp av samme metode som for byindeks. Denne metoden er basert på metoden for vegtrafikkindeksen.
...
Tabellen nedenfor viser sykkelindeksen for hvert år, samt for hele perioden fra 2016 fram til og med juni 2019.
...
city_info %>% 
  ...
  padding(padding.top = .3,
          padding.bottom = .3) %>% 
  set_caption("Estimert endring i syklende i Grenland.")
```

\newline
**Sykkelindeksen for Grenland estimerer endringen i antall syklende fra 2016 til 2019 (til og med juni) til å være -10,9 %.**
...
ggplot() +
  ...
  ggtitle("Estimert endring i antall syklende i Grenland",
...
Tabellen nedenfor gjengir sykkelindekspunktene og deres indeksverdi for 2019. ÅDT er fra 2016.
...
ggplot2::ggplot() +
  ...
  geom_hline(yintercept = -10.9, color = "#58B02C") +
  xlab("") +
  ylab("Endring (%)") +
