...
\newline
**Sykkelindeksen for Grenland estimerer endringen i antall syklende fra 2016 til 2019 (til og med juni) til å være -6,6 %.**
...
ggplot2::ggplot() +
  ...
  geom_hline(yintercept = -6.6, color = "#58B02C") +
  xlab("") +
  ylab("Endring (%)") +
