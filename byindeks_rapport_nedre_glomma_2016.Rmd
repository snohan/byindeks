...
# Bakgrunn
Byindeksen er beregnet med 2016 som referanseår.
...
# Byindeksen
Byindeksen estimerer endring i trafikkmengde for "lette" biler, da det er dette som er i fokus for "nullvekstmålet". Lette biler er målt til en lengde under 5,6 m ved trafikkregistreringsstasjonene. I datagrunnlaget inngår næringstransport med kjøretøy under 5,6 m da det ikke er mulig å skille disse fra andre kjøretøy. Motorsykler inngår også. Det er heller ikke kompensert for ren gjennomgangstrafikk.
...
city_info %>% 
  ...
  colformat_num(col_keys = "konfidensintervall", digits = 1) %>%
...
\newline
**Byindeksen estimerer endringen i trafikkmengden fra 2016 til 2019 (til og med august) til å være 1,7 %.**
...
Tabellen nedenfor gjengir byindekspunktene og deres indeksverdi for 2019. ÅDT gjelder for lette kjøretøy i 2016.
...
ggplot2::ggplot() +
  ...
  geom_rect(aes(xmin = -Inf, xmax = Inf, ymin = 0.1, ymax = 3.3),
